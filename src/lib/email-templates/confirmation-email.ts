/**
 * Email templates for payment confirmation emails
 * Based on subscription types: basic and pro
 */
...
export function getConfirmationEmailHTML(data: PaymentData): string {
...
export function getEmailSubject(planType: 'basic' | 'pro'): string {
